...
### Changed
- Upgraded C# projects to .NET 10.0 and pinned SDK to `10.0.300`.
- Bumped package/module versions to `0.9.0`.
- Updated documentation and build scripts for the new SDK and version.
